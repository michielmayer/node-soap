...
Client.prototype.setSSLSecurity = function(security) {
...
Client.prototype._invoke = function(method, args, location, callback, options, extraHeaders) {
  ...
  if (self.sslSecurity && self.sslSecurity.addHeaders)
    self.sslSecurity.addHeaders(headers);
  if (self.sslSecurity && self.sslSecurity.addOptions)
    self.sslSecurity.addOptions(options);

...
WSSecurityCert.prototype.postProcess = function (xml, envelopeKey) {
  ...
  this.signer.addReference("//*[name(.)='wsa:MessageID']", references);
  this.signer.addReference("//*[name(.)='wsa:To']", references);
  this.signer.addReference("//*[name(.)='wsa:Action']", references);
